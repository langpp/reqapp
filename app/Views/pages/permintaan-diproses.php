...
<ol class="breadcrumb float-xl-right">
  ...
  <li class="breadcrumb-item active">Permintaan Diproses</li>
</ol>

<h1 class="page-header">Permintaan Diproses <small>List Data Permintaan Diproses</small></h1>
  ...
  <div class="col-xl-12">
    ...
    <div class="panel panel-inverse" data-sortable-id="index-1">
      <div class="panel-heading">
        <h4 class="panel-title">List Permintaan Diproses</h4>
      ...
      <div class="panel-body">
        <table id="tbl-permintaan-diproses" class="table table-bordered table-striped table-hovered w-100">
          <thead>
            <tr>
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <select name="status" id="e_status" class="form-control" required>
              ...
              <option value="3">Permintaan Selesai</option>
            </select>
          </div>
        </div>
...
<script>
  $(function() {
    ...
    const datatable = $('#tbl-permintaan-diproses').DataTable({
      responsive: true,
      processing: true,
      serverSide: true,
      order: [],
      ajax: {
        url: `${url}/permintaan-diproses/list`,
        type: "GET"
      },
      language: {
    ...
    // * Get Data for Edit
    $("#tbl-permintaan-diproses tbody").on("click", ".edit", function() {
      let id = $(this).data('id');
