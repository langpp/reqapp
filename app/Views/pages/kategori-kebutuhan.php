      ...
      <form id="form-tambah" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Kode Kategori <i class="fa fa-info-circle" title="Contoh: 5.2.2.01.05."></i></label>
            <input id="i_kode_kategori" name="kode_kategori" class="form-control form-control-sm" type="text" required>
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form id="form-edit" enctype="multipart/form-data">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Kode Kategori <i class="fa fa-info-circle" title="Contoh: 5.2.2.01.05."></i></label>
            <input id="e_kode_kategori" name="kode_kategori" class="form-control form-control-sm" type="text" required>
          </div>
          <div class="form-group">
            <label>Kategori Kebutuhan <i class="fa fa-info-circle" title="Contoh: Rumah Tangga."></i></label>
    ...
    $("#tbl-kategori-kebutuhan tbody").on("click", ".edit", function() {
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          $("#e_kode_kategori").val(data.kode_kategori);
