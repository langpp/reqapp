...
<ol class="breadcrumb float-xl-right">
  ...
  <li class="breadcrumb-item active">Permintaan Selesai</li>
</ol>

<h1 class="page-header">Permintaan Selesai <small>List Data Permintaan Selesai</small></h1>
  ...
  <div class="col-xl-12">
    ...
    <div class="panel panel-inverse" data-sortable-id="index-1">
      <div class="panel-heading">
        <h4 class="panel-title">List Permintaan Selesai</h4>
      ...
      <div class="panel-body">
        <table id="tbl-permintaan-selesai" class="table table-bordered table-striped table-hovered w-100">
          <thead>
            <tr>
